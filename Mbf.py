...
def tokenz():
	...
	try:
		...
		os.system('clear')
		logo()
		print(" %s[*] Author     : ZAINUN NAJIB."%(N))
		print(" [*] Github     : https://github.com/Jib-Zuckerberg")
		print(" [*] ---------------------------------------------")
		print(" [*] Bergabung  : %s"%(tgl))
		print(" [*] Status     : %sPremium sampe kiamat%s"%(H,N))
		print(" [*] ---------------------------------------------")
		print(" [*] IP         : %s"%(IP))
		token = raw_input('\n [?] masukan token : ')
		try:
...
def emailfb():
	x = 111
	xx = 999
	nama = input(" [?] masukan nama (cth: yumee): ")
	nama = nama.replace(" ", "")
...
def laporbug():
	...
	if asulo == "":
		menu()
	os.system('xdg-open https://wa.me/6285600880923?text=' +asulo)
	input("\n [*] tekan enter untuk kembali ke menu")
	menu()
### BAGIAN SANDI ####
def atursandi():
